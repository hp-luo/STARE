...
from .stare_ray_trainer import RaySTARETrainer

@hydra.main(config_path="config", config_name="agent_math_trainer", version_base=None)
def main(config):
...
class TaskRunner:
    ...
    def add_actor_rollout_worker(self, config):
        ...
        use_legacy_worker_impl = config.trainer.get("use_legacy_worker_impl", "auto") #auto

        # use new model engine implementation
        if use_legacy_worker_impl == "disable": # False
        ...
        if config.actor_rollout_ref.actor.strategy in {"fsdp", "fsdp2"}: #fsdp
